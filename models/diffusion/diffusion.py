# Denoising Diffusion (Schedule, MLP, Loss, Sampling)
...
print(f" Noise schedule defined ({NUM_DIFFUSION_STEPS} steps)")
print(f"   range: [{betas[0]:.4f}, {betas[-1]:.4f}]")
print(f"  _T: {alphas_cumprod[-1]:.6f} (signal almost destroyed)")
...
class DenoisingMLP(nn.Module):
    ...
    def forward(self, x_t, t, cond):
        ...
        return self.net(h)
print("DenoisingMLP defined (custom-built from scratch)")
...
print(" Diffusion loss function defined (score matching)")
...
print(" Reverse diffusion sampling function defined")
